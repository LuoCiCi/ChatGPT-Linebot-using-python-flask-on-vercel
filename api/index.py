        ...
        try:
            response = client.models.generate_content(
                ...
                config={
                    ...
                    # 🟢 終極簡化指令：不給任何數字限制、不給任何否定句，讓 AI 語氣恢復自然
                    "system_instruction": (
                        "你是台灣的精煉 LINE 聊天助手。請完全使用繁體中文(台灣)回答。\n"
                        "回答請開門見山、直接講重點。請用自然流暢的一兩句話簡短回答完畢。"
                    ),
                    "temperature": 0.2,       # 🟢 提高到 0.6，給大腦一點自然的流暢度，拒絕死板
                    "max_output_tokens": 200  # 限制最大字數
                }
            )
